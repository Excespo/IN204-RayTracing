...
set MESSAGE=10samples on 4 threads, 1280, with quad on spheres

:: Run the program
build\ray_tracing %output_file% -m "%MESSAGE%" -s %n_samples% -d %max_depth% -w %image_width% -a -p -n %n_threads%
